...
• archiving                                      name=dist/skoed_0.0.1-next_linux_amd64.tar.gz
• archiving                                      name=dist/skoed_0.0.1-next_linux_arm64.tar.gz
• creating                                       package=skoed format=deb arch=amd64v1 file=dist/skoed_0.0.1-next_amd64.deb
• creating                                       package=skoed format=deb arch=arm64v8.0 file=dist/skoed_0.0.1-next_arm64.deb
• release succeeded after 28s

$ file dist/skoed_linux_amd64_v1/skoed dist/skoed_linux_arm64_v8.0/skoed
dist/skoed_linux_amd64_v1/skoed: ELF 64-bit LSB executable, x86-64, …, statically linked, Go BuildID=…
dist/skoed_linux_arm64_v8.0/skoed: ELF 64-bit LSB executable, ARM aarch64, …, statically linked, Go BuildID=…
```
...
ls dist/
# checksums.txt
# skoed_0.0.1-next_amd64.deb
# skoed_0.0.1-next_arm64.deb
# skoed_0.0.1-next_linux_amd64.tar.gz
# skoed_0.0.1-next_linux_arm64.tar.gz
...
#   - build .deb for both
#   - buildx multi-arch image → ghcr.io/skoed/skoed:0.5.1 + :latest
