...
//
//	body  : {"url":"<http(s)://…>", "format":"hosts|domainlist|askoed|auto"}
...
//     URL BEFORE installing skoed or setting up admin auth.
...
// SKOED_PUBLIC_TESTER_ALLOW_PRIVATE=1 is set, the SSRF guard accepts
...
var testOnlyAllowPrivate = os.Getenv("SKOED_PUBLIC_TESTER_ALLOW_PRIVATE") == "1"
